...
description: "This tutorial serves as an introduction to the different options for incorporating vital dynamics (births, deaths, and age structure) into the ABM model."
