...
- [Model types](../model-types/index.md) — explanation of the three model types and their trade-offs
- [Choosing a model type](../model-types/choosing-a-model.md) — decision guide for selecting the right model
- [Components](../components/index.md) — how the component system works
